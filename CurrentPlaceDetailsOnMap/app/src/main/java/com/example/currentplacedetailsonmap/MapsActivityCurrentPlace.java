    ...
    public void onMapReady(GoogleMap map) {
        ...
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                //TODO: Make the Pickup button visible and disabled
                pickupButton.setVisibility(View.VISIBLE);
                disableButton(pickupButton);
                //Checking if the user is close enough to the torch
                if(calculateDistance(mLastKnownLocation, marker.getPosition()) > MINIMUM_PICKUP_DISTANCE){
                    ...
                    //TODO: Enable the Pickup button if the user does not have a torch already
        ...
        mMap.setOnInfoWindowCloseListener(new GoogleMap.OnInfoWindowCloseListener() {
            ...
            public void onInfoWindowClose(Marker marker) {
                //TODO: Make the Pickup button vanish from the UI and disable it
                selectedMarker = null;
